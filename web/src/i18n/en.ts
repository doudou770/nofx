export const en = {
  ...
  openCommunityDriven:
    'The premier AI Signal Marketplace connecting you to institutional-grade strategies.',
  openSourceSelfHosted: 'Global Signal Ecosystem',
  openSourceDesc:
    'Access a diverse marketplace of winning strategies. Choose from our battle-tested Official Agents or subscribe to top-ranked Third-Party Experts. Data is transparent, choices are yours.',
  openSourceFeatures1: 'Exclusive Official AI Signals',
  openSourceFeatures2: 'Verified Third-Party Providers',
  openSourceFeatures3: 'Transparent Performance Tracking',
  openSourceFeatures4: 'One-Click Auto-Subscription',
  multiAgentCompetition: 'Adaptive Agentic Intelligence',
  multiAgentDesc:
    'Our AI doesn\'t just trade; it evolves.Multi - agent systems monitor the market 24/7, automatically adapting strategies to volatility to maximize Alpha while minimizing risk.',
  multiAgentFeatures1: '24/7 Automated Execution',
  multiAgentFeatures2: 'Real-time Strategy Adaptation',
  multiAgentFeatures3: 'Smart Risk Management',
  multiAgentFeatures4: 'Multi-Asset Support (Crypto/Stocks)',
  secureReliableTrading: 'Non-Custodial Security',
  secureDesc:
    'Your funds never leave your exchange. Equinai operates via encrypted API connections with strict "Trade-Only" permissions. We execute trades, but you retain 100% control of your assets.',
  secureFeatures1: 'Funds Stay on Your Exchange',
  secureFeatures2: 'Encrypted API Connection',
  secureFeatures3: 'No Withdrawal Permissions',
  secureFeatures4: 'Enterprise-Grade Infrastructure',

  // About Section
  aboutNofx: 'About Equinai',
  whatIsNofx: 'What is Equinai?',
  nofxNotAnotherBot:
    "Starting with the high-velocity Crypto markets as our proving ground,",
  nofxDescription1:
    'we are evolving to master Stocks, Futures, and Forex. ',
  nofxDescription2:
    "",
  nofxDescription3:
    'Our core engine fosters\'Strategy Darwinism\' — a competitive ecosystem where only the most profitable',
  nofxDescription4:
    'AI agents survive and thrive, ensuring you always have access to the market\'s best performing strategies.',
  nofxDescription5:
    '',
